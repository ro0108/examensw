...
$(document)
		.ready(
				function() {
					...
					}else if (viewname == 'json-to-java-converter') {
						createEditor("json","java");
						setViewTitle("Online JSON TO JAVA Converter", true, true);
					} 
...
function convertJsonToJava(){
	var jsonData = editorAce.getValue();
	createJavaObject(jsonData);
}
