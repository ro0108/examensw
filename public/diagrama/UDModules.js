...
var ConnectorActivity = function(a) {
    a = a || {}; /*http://www.jrromero.net/tools/jsUML2*/
...
Pin.prototype.correctPosition = function() {
    ...
    if (this._action.getX() == b) {
        ...
        if (this._action.getY() == l) {
            ...
            if ((this._action.getX() + this._action.getWidth()) == b) { /*http://www.jrromero.net/tools/jsUML2*/
...
Flow.prototype._checkForNewNodes = function(a, e) {
    if (this._selectedPoint && (this._selected == 0 || this._selected == this._points.length - 1)) { /*http://www.jrromero.net/tools/jsUML2*/
...
UnhierarchicalSwimlane.prototype.updateContainer = function(e) {
    ...
    if (this._container) {
        ...
        if (g < this._x || d < this._y) { /*http://www.jrromero.net/tools/jsUML2*/
...
GeneralizationSet.prototype.isXOriented = function() { /*http://www.jrromero.net/tools/jsUML2*/
...
Instance.prototype.getNameAsComponent = function() { /*http://www.jrromero.net/tools/jsUML2*/
    return this._components[1]
};
...
Lifeline.prototype.updatePosition = function(d, b) {
    ...
    if (d == undefined || b == undefined) {
        ...
        var b = e.getY();
        this.resetMovement();
        for (c in this._relations) { /*http://www.jrromero.net/tools/jsUML2*/
            this._relations[c].updatePosition()
        }
    } else {
        this._x += d;
...
Lifeline.prototype.setName = function(a) { /*http://www.jrromero.net/tools/jsUML2*/
    this._components[1].setValue(a)
};
...
GeneralizationSet.prototype._calculateLineEnds = function() {
    ...
    if (this._elemA == this._elemB) {
        ...
        var e;
        var m;
        if (this._selected == 2 || this._selected == 0 || this._selected == g - 1 || (this._selected == -1 && !this._elemA._moved) || this._elemA._resizing) { /*http://www.jrromero.net/tools/jsUML2*/
            if ((n - d) > 0) {
                if ((h - c) > 0) {
                    a = this._elemA.getLinkCentered(d, c + this._elemA.getHeight() / 2);
                    p = this._elemA.getLinkCentered(d + this._elemA.getWidth() / 2, c);
...
GeneralizationSet.prototype.setLineWidth = function(a) {
    GeneralizationSet.base.setLineWidth.call(this, a);
    for (i in this._relations) { /*http://www.jrromero.net/tools/jsUML2*/
        if (this._relations[i].getType() == "SetLine") {
            this._relations[i].setLineWidth(a)
        }
    }
