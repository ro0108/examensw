...
Element.prototype.draetUniueID = function(a, b) {};
...
Component.prototype.notifyChange = function() {
    if (this._parent) {
        ...
        if (this._parent && this._parent._parent instanceof SuperNode) { /*http://www.jrromero.net/tools/jsUML2*/
...
SuperComponent.prototype.getComponentXML = function(c) {
    ...
    if (this.getFontStyle() != "normal") { /*http://www.jrromero.net/tools/jsUML2*/
...
SuperComponent.prototype.notifyToUp = function(c) {
    var b;
    var a = c; /*http://www.jrromero.net/tools/jsUML2*/
...
SuperComponent.prototype.notifyChange = function() {
    this.updateComponents(); /*http://www.jrromero.net/tools/jsUML2*/
    if (this._parent) {
        if (this._parent instanceof SuperNode) {
            this._parent.notifyChange(true)
        } else {
...
var Text = function(a) {
    a = a || {};
    Text.baseConstructor.call(this, a); /*http://www.jrromero.net/tools/jsUML2*/
    this.setFontColor(a.text_color || "#000000");
    this.setFontSize(a.font_size || "12");
    this._font_width = this.getFontSize() / 1.5;
...
Text.prototype.getComponentXML = function(b) {
    var a = b.createElement("item"); /*http://www.jrromero.net/tools/jsUML2*/
    if (this._id) {
        a.setAttribute("id", this._id)
    }
    if (this.getFontColor() != "#000000") {
...
CollapsibleFields.prototype.drawShape = function(b) {
    ...
    if (this.visibilitySubComponents()) {
        ...
        b.lineTo(a + 10, c + 5);
        b.lineTo(a + 5, c);
        b.closePath(); /*http://www.jrromero.net/tools/jsUML2*/
        b.fill();
        b.fillStyle = "#94dc91";
        b.beginPath();
...
TimeEventFigure.prototype.draw = function(c, b, e, d, a) {
    var b = JSGraphic.toPixel(b);
    var e = JSGraphic.toPixel(e);
    c.save(); /*http://www.jrromero.net/tools/jsUML2*/
    c.shadowOffsetX = 2;
    c.shadowOffsetY = 2;
    c.shadowBlur = 2;
    c.shadowColor = "rgba(0, 0, 0, 0.5)";
...
VerticalSwimlaneFigure.prototype.draw = function(c, b, e, d, a) {
    ...
    c.shadowOffsetX = 2;
    c.shadowOffsetY = 2;
    c.shadowBlur = 2; /*http://www.jrromero.net/tools/jsUML2*/
    c.shadowColor = "rgba(0, 0, 0, 0.5)";
    c.fillStyle = this.getColor();
    c.beginPath();
    c.moveTo(b, e + a);
...
Node.prototype.deselect = function() {
    this.deselectComponent(); /*http://www.jrromero.net/tools/jsUML2*/
    this._selectedBefore = false;
    this._selected = false
};
...
Node.prototype.showStyleDialog = function(e) {
    ...
    aa.setAttribute("type", "radio"); /*http://www.jrromero.net/tools/jsUML2*/
    ...
    Q.setAttribute("style", "width: 65px");
    ...
    ac.setAttribute("style", "width: 65px");
    ...
    N.appendChild(r); /*http://www.jrromero.net/tools/jsUML2*/
    N.appendChild(h);
    N.appendChild(x);
    N.appendChild(v);
    N.appendChild(y);
    ...
    var J = function(ah) {
        var ag = function(an) {
            ...
            var ak = parseInt(an) % 16;
            var am = (parseInt(an) - ak) / 16;
            hex = "" + al.charAt(am) + al.charAt(ak);
            return hex
        };
        var af = ag(ah[0]) + ag(ah[1]) + ag(ah[2]);
        while (m.hasChildNodes()) {
            m.removeChild(m.lastChild)
        }
        var ae = document.createElement("font");
        ae.style.color = "#" + af;
        var aj = document.createTextNode("#");
        var ai = document.createTextNode(af);
        ae.appendChild(aj);
        ae.appendChild(ai);
        m.appendChild(ae);
        C("#" + af)
...
Node.prototype.updateContainer = function(d) {
    ...
    if (this._container) {
        ...
        var e = this._x;
        var c = this._y;
        var b = this._x; /*http://www.jrromero.net/tools/jsUML2*/
        var a = this._y;
        var f;
        var l, k, j, g;
...
Node.prototype.isOverComponent = function(b, e, a) {
    ...
    for (c = 0; c < this._components.length; c += 1) {
        if (this._components[c].isOver(b, e, d)) { /*http://www.jrromero.net/tools/jsUML2*/
            return true
        }
    }
    return false
...
var DashedLine = function() {}; /*http://www.jrromero.net/tools/jsUML2*/
...
AggregationEnd.prototype.draw = function(c, a, e, d, b) {
    ...
    c.beginPath();
    c.moveTo(0, 0);
    c.lineTo(-7, -5); /*http://www.jrromero.net/tools/jsUML2*/
    c.lineTo(-14, 0);
    c.lineTo(-7, 5);
    c.closePath();
    c.fill();
...
Relation.prototype._updateComponents = function() {
    ...
    if (this._multiB) {
        ...
        if (this._elemB instanceof Relation) {
            ...
            var g = Math.atan2(p - s, q - a); /*http://www.jrromero.net/tools/jsUML2*/
            var b = Math.tan(g);
...
Relation.prototype.select = function(c, e) {
    ...
    for (var d = 0; d < this._points.length - 1; d++) {
        if (this._selectLine(this._points[d], this._points[d + 1], c, e, 20)) { /*http://www.jrromero.net/tools/jsUML2*/
            if (this._selected > -1) {
                this._selectedBefore = true
            }
            this._selected = d;
...
Relation.prototype._calculateLineEnds = function() {
    ...
    if (this._elemA == this._elemB) {
        ...
        if (f > 2) {
            ...
            a = this._elemA.getLinkCentered(this._elemB.getCentralPoint()); /*http://www.jrromero.net/tools/jsUML2*/
...
Relation.prototype.showStyleDialog = function(e) {
    ...
    A.appendChild(j);
    var a = j.getContext("2d");
    var E = document.createElement("div"); /*http://www.jrromero.net/tools/jsUML2*/
    ...
    var O = document.createElement("input"); /*http://www.jrromero.net/tools/jsUML2*/
...
Relation.prototype.getDirectionToA = function() {
    if (this._directionA != undefined) {
        ...
        if (!(this._start instanceof OpenTip) && !(this._end instanceof OpenTip)) {
            ...
            if (this._start instanceof OpenTip) { /*http://www.jrromero.net/tools/jsUML2*/
                return true
            }
        }
    }
...
Diagram.prototype._generateStructure = function(b, d, a) {
    ...
    this._width = d; /*http://www.jrromero.net/tools/jsUML2*/
    this._height = a;
    this._minWidth = d;
...
TextArea.prototype.showDialog = function() {
    ...
    this._active = true;
    var f = document.createElement("div");
    var b = document.createElement("form"); /*http://www.jrromero.net/tools/jsUML2*/
...
LoopItem.prototype.encode = function(a) { /*http://www.jrromero.net/tools/jsUML2*/
    var b = "LOOP";
    if (a[0]) {
        b += "(" + a[0]
    }
...
RegionLine.prototype.select = function(b, g) {
    ...
    if (!this.selected && this.isOver(b, g)) {
        ...
        this._dropComponent = function(h) {
            ...
            f.getParent()._selected = true; /*http://www.jrromero.net/tools/jsUML2*/
...
SuperNode.prototype.draw = function(b) {
    ...
    b.restore(); /*http://www.jrromero.net/tools/jsUML2*/
    this.drawFigures(b);
...
SpecificationItem.prototype.showDialog = function() {
    ...
    for (e = 0; e < 6; e += 2) {
        ...
        h[e].appendChild(c);
        c = document.createElement("option"); /*http://www.jrromero.net/tools/jsUML2*/
        c.value = "1";
